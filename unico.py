...
output_file = "4_final_com_imagens.pdf"
...
def inserir_imagens(temp_pdf_path, image_list, page_rect, translated_text, doc):
    ...
    # Adicionar o texto traduzido na nova página, preservando formatação
...
def combinar_com_imagens(input_path, translated_path, output_path):
    ...
    for page_number in range(len(doc)):
        ...
        # Obter o texto traduzido mantendo a formatação original
