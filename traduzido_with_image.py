...
def criar_pagina_pdf(temp_pdf_path, translated_text, page_rect, image_list):
...
def traduzir_pdf(input_path, output_path):
    ...
    for page_number in range(len(doc)):
        ...
        # Criar o PDF temporário com a página traduzida e as imagens
        criar_pagina_pdf(temp_pdf_path, translated_text, page.rect, image_list)
